...
原始發想是為了轉職所做的整合火車及公車預定時刻表，目前在公車部分卡關，先將火車部分整理上線，後續再慢慢完善

- [火車時刻查詢](https://train-bus-status.netlify.app/)

- [火車站點即時狀態](https://train-bus-status.netlify.app/LiveStation)
> 做給朋友用的 side project
